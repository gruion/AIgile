...
const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { href: "/planning", label: "Planning", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" },
  ...
  },
  {
    title: "AI & Insights",
    items: [
      { href: "/insights", label: "AI Summaries", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-3 h-12 border-b border-gray-800 shrink-0">
        ...
        {!collapsed && <span className="text-sm font-semibold text-white truncate">Jira Dashboard</span>}
      </div>
